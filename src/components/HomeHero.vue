...
<div class="main">
    <v-container>
        <v-layout column>
            ...
            <v-flex  class="display-2 text-xs-center my-5 font-weight-bold">Why you should join Jeff`s GYM</v-flex>
...
<!--         <template>
       <v-progress-linear :indeterminate="true" color="green"></v-progress-linear>
        ...
        <v-progress-linear :indeterminate="true" background-color="greenyellow" color="green"></v-progress-linear>  -->
            </v-flex>
            <v-flex>
                <div class="p">
                <p class="text-lg-center font-weight-bold"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem nobis fugiat excepturi, at nulla ratione impedit accusamus tempora. Fuga velit temporibus eius. Aperiam voluptatem, quisquam pariatur vitae consequuntur ad quibusdam?
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam nulla aliquid labore aperiam id consequatur nobis porro error nemo non? Id, quibusdam cumque nam atque rem sed porro inventore nemo.
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem, odit laboriosam aspernatur ducimus earum quisquam molestiae ab delectus. Ab iste sint maxime aliquam incidunt veritatis. Assumenda aliquid blanditiis nostrum officiis?
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita nobis dolores error labore quibusdam, ab praesentium suscipit consectetur reiciendis nisi odio similique asperiores nesciunt. Vero dolorem ducimus quisquam. Neque, voluptates?
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Exercitationem, praesentium consectetur, nulla fugiat, quas mollitia debitis est placeat quam voluptatum neque labore et eveniet ea eaque commodi corporis sint recusandae.
                   </p> 
<!--                <div class="headline mt-3">Lorem ipsum</div>
                <p class="subheading mt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras pulvinar risus quis mauris interdum, in euismod nibh pretium. Etiam pulvinar tincidunt dapibus. Quisque sollicitudin, mauris a consequat consectetur, turpis nisl sollicitudin enim, id consectetur neque neque nec metus. Pellentesque dolor nisi, vulputate quis lobortis ac, tincidunt et quam. Mauris pulvinar blandit nisi nec mattis. Aliquam accumsan ut sem eget efficitur. Vivamus in tortor gravida eros laoreet condimentum nec vel dui. Nullam quam massa, ultrices eget tincidunt a, pulvinar ac libero.</p>
